...
function updateMusicListUI() {
    ...
    const playingItem = document.getElementById(`musicListItem${track_index}`);
    playingItem.classList.add('playing');
  
    const nowPlayingLabel = document.querySelector('.now-playing');
    nowPlayingLabel.textContent = `Now Playing: ${playingItem.textContent}`;
  }
